    ...
    const fetchAlumno = async () => {
        if (alumnosContract && niu) {
            try {
                ...
                showNotificationMessage('Alumno encontrado', 'success');
            } catch (error) {
                showNotificationMessage('Alumno no encontrado', 'error');
    ...
    const updateAlumno = async () => {
        if (alumnosContract && niu) {
            try {
                ...
                showNotificationMessage('Datos del alumno actualizados correctamente', 'success');
            } catch (error) {
                showNotificationMessage('Error actualizando los datos del alumno', 'error');
