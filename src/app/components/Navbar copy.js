                ...
                <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                    <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        ...
                        {account ? (
                            <button
                                type="button"
                                className="py-2 px-4 bg-blue-700 text-white rounded-full shadow-lg hover:bg-blue-500 ml-4 transition-transform transform hover:scale-105"
                            >
                            ...
                            <button
                                type="button"
                                className="py-2 px-4 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-full shadow-lg hover:bg-blue-700 ml-4 transition-transform transform hover:scale-105"
